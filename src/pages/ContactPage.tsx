          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-12">
            ...
            <div className="flex flex-col gap-6 pt-1">
              {[
                ...
                {
                  icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C4A265" strokeWidth="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>,
                  label: 'Email',
                  value: 'contact@aurex.ma',
                },
                {
